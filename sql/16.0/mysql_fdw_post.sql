...
--Testcase 4:
CREATE USER MAPPING FOR CURRENT_USER SERVER mysql_svr
  OPTIONS (username :MYSQL_USER_NAME, password :MYSQL_PASS);
--Testcase 5:
CREATE USER MAPPING FOR CURRENT_USER SERVER mysql_svr2
  OPTIONS (username :MYSQL_USER_NAME, password :MYSQL_PASS);
...
--Testcase 714:
DROP USER MAPPING FOR CURRENT_USER SERVER mysql_svr2;
--Testcase 389:
